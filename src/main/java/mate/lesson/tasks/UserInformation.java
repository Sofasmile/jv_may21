...
public class UserInformation {
    /**
     * The input parameter is a list (List<String>) with information about users and their year of birth as follows:
     * "Alice : 2000"
     * "Bob:  1998"
     * "John :1997"
     *
    ...
    public static int[] getBirthYears(List<String> userData) {
        ...
        for (int i = 0; i < userData.size(); i++) {
            years[i] = Integer.valueOf(userData.get(i).split(":")[1].trim());
        }
        Arrays.sort(years);
        return years;
    }
